...
public class Langueage extends AppCompatActivity {
    ...
    public void changelanguage(){
        ...
        loading = ProgressDialog.show(Langueage.this, "", "Loading...", true);
        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("sessionId",sesionid_new);
        jsonObject.addProperty("languageCd", stringlang);
        jsonObject.addProperty("ver",BuildConfig.VERSION_NAME);
        IRetrofit jsonPostService = ServiceGenerator.createService(IRetrofit.class, baseurl);
        Call<JsonObject> panggilkomplek = jsonPostService.changelanguage(jsonObject);
...
//                    loading.dismiss();
                    ...
                    if (clocksts){
                        ...
                        startActivity(new Intent(Langueage.this, ClockInActivity.class));
                        finish();
