...
public class DailyReportAddPM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_details_daily_report_add_p_m);
...
//        myitem_place5 = findViewById(R.id.createdby);
        ...
        //setlayout recyler
        linearLayoutManager = new LinearLayoutManager(DailyReportAddPM.this, LinearLayout.VERTICAL,false);
        linearLayoutManager2 = new LinearLayoutManager(DailyReportAddPM.this, LinearLayout.VERTICAL,false);
        linearLayoutManager3 = new LinearLayoutManager(DailyReportAddPM.this, LinearLayout.VERTICAL,false);
        linearLayoutManager4 = new LinearLayoutManager(DailyReportAddPM.this, LinearLayout.VERTICAL,false);
        ...
        mplustemuan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (minputtemuan.length()==0){
                    Toast.makeText(DailyReportAddPM.this, "Text tidak boleh kosong", Toast.LENGTH_SHORT).show();
                }else {
...
////////////////////// adapter di masukan ke recyler//
                    addFormAdapterAdapter1 = new AddDailyTemuanAdapter(DailyReportAddPM.this, temuanlist);
...
////////////////////// adapter di masukan ke recyler//
                    addFormAdapterAdapter2 = new AddDailyActionAdapter(DailyReportAddPM.this, actionlist);
...
////////////////////// adapter di masukan ke recyler//
                    addFormAdapterAdapter3 = new AddDailyFollowAdapter(DailyReportAddPM.this, followlist);
        ...
        final ArrayAdapter<String> kategori = new ArrayAdapter<String>(DailyReportAddPM.this, R.layout.spinstatus_layout,
                caseprogspin);
        ...
        final ArrayAdapter<String> kategori2 = new ArrayAdapter<String>(DailyReportAddPM.this, R.layout.spinstatus_layout,
                pressspin);
...
//                    list5 = gson.fromJson(listformreq4.toString(), listType5);
                    ...
                    addFormAdapterAdapter2 = new AddDailyActionAdapter(DailyReportAddPM.this, actionlist);
                    addFormAdapterAdapter3 = new AddDailyFollowAdapter(DailyReportAddPM.this, followlist);
                    addFormAdapterAdapter4 = new DetailsDailyAdapter4(DailyReportAddPM.this, sperpartlist);
                    ...
                    Toast.makeText(DailyReportAddPM.this, errornya,Toast.LENGTH_LONG).show();
                }
            ...
            public void onFailure(Call<JsonObject> call, Throwable t) {
                Toast.makeText(DailyReportAddPM.this, getString(R.string.title_excpetation),Toast.LENGTH_LONG).show();
                cekInternet();
                mfooterload.setVisibility(View.GONE);
...
//        page=1;
//        mfooterload.setVisibility(View.VISIBLE);
        loading = ProgressDialog.show(DailyReportAddPM.this, "", "loading...", true);
        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("sessionId",sesionid_new);
        jsonObject.addProperty("serviceTicketCd",noreq);
        ...
        panggilkomplek.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                if (statusnya.equals("OK")){
                    ...
                    Toast.makeText(DailyReportAddPM.this, message,Toast.LENGTH_LONG).show();
                    onBackPressed();
//                    loadData();
                }else {
                    sesionid();
                    loading.dismiss();
                    Toast.makeText(DailyReportAddPM.this, errornya.toString(), Toast.LENGTH_SHORT).show();
...
//                    }
    ...
    public void cekInternet(){
        ...
        ConnectivityManager connectivityManager = (ConnectivityManager) DailyReportAddPM.this.getSystemService(Context.CONNECTIVITY_SERVICE);
                ...
                connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI).getState() == NetworkInfo.State.CONNECTED)
        {
            ...
            internet=false;
            Intent noconnection = new Intent(DailyReportAddPM.this, NoInternet.class);
...
//                finish();
            ...
            startActivity(new Intent(DailyReportAddPM.this, Login.class));
            finish();
            Toast.makeText(DailyReportAddPM.this, getString(R.string.title_session_Expired),Toast.LENGTH_LONG).show();
        }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent back = new Intent(DailyReportAddPM.this, DetailsPM.class);
