...
public class DailyReportItem {
    ...
    public DailyReportItem(String serviceTicketCd, String date, String pressGuid, String pressName, String status, String statusName, String statusColorCode, String visitDateTime, String additionalTextHtml) {
