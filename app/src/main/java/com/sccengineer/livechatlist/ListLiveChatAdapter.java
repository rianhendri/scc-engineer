 ...
 *  java.util.Locale
 */
package com.sccengineer.livechatlist;
...
//        databaseReference5.child("chat").child(myItem.get(i).getLiveChatID()).child("listchat").addValueEventListener(new ValueEventListener() {
//            @Override
...
//                        itemchat2.add(fetchDatalist);
//                    }
//                    for (int i = 0; i < itemchat2.size(); i++) {
//                        if (itemchat2.get(i).getName().equals(namea)){
//                            myviewholder.mdot.setVisibility(View.GONE);
//                        }else {
//
//                            if (itemchat2.get(i).getRead().equals("yes")){
//                                myviewholder.mdot.setVisibility(View.GONE);
//                            }else {
//                                total1 +=1;
//                                myviewholder. mdot.setVisibility(View.VISIBLE);
//                                myviewholder.mnewnotif.setText(String.valueOf(total1));
//                            }
//                        }
//                    }
//
...
//            }
//        });
//        myviewholder.minitialname.setText(myItem.get(i).getUserName());
        ...
        if (myItem.get(i).getPengirim()!=null){
...
//                tokennya2.add(myItem.get(i).getOthersFirebaseToken().get(i).getToken());
                ...
                if (titlenya.equals("List Live Chat")){
                    cs ="no";
                }else {
                    cs ="yes";
                }
                ...
                gotonews.putExtra("moduletrans",myItem.get(i).getModuleTransactionNo() );
                gotonews.putExtra("id",myItem.get(i).getTitle());
                gotonews.putExtra("cs", cs);
                gotonews.putExtra("titlelist", titlenya);
