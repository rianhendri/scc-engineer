 ...
 *  java.util.ArrayList
 */
package com.sccengineer.notifikasiclockin.notifikasihome;
...
public class NotifclockAdapter extends RecyclerView.Adapter<NotifclockAdapter.Myviewholder> {
    private LinearLayoutManager linearLayoutManager;
    Context context;
    ArrayList<NotifclockItems> myItem;
    public static int positem = 0;
    public static RecyclerView mchatdialog;
    public NotifclockAdapter(Context c, ArrayList<NotifclockItems> p){
        context = c;
        myItem = p;
    }
    ...
    public Myviewholder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new Myviewholder(LayoutInflater.from(context).inflate(R.layout.item_notifhome2,
                viewGroup, false));
