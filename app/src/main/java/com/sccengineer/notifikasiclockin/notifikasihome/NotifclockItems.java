...
public class NotifclockItems {



    public NotifclockItems() {
    }


    public NotifclockItems(String shortContent, String title, String guid, String engineerCd, String content, String postedDateTime, String readDateTime, boolean stsRead) {
