...
public class STSendSparepart_item {

    public STSendSparepart_item() {
    }

    public STSendSparepart_item(String sparePartCodeAndName, String sparePartCd, String name, String sparePartName) {
