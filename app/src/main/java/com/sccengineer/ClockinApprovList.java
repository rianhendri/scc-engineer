...
public class ClockinApprovList extends AppCompatActivity {
    boolean load = true;
    ...
    ReClockInAdapter addFormAdapterAdapter;
    boolean internet = true;
    private LinearLayoutManager linearLayoutManager;
    public static ArrayList<ReclockinItems> list2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_clockin_approv_list);
...
//            Toast.makeText(DetailsNotification.this, guid,Toast.LENGTH_LONG).show();
        ...
        //setlayout recyler
        linearLayoutManager = new LinearLayoutManager(ClockinApprovList.this, LinearLayout.VERTICAL,false);
//        linearLayoutManager.setReverseLayout(true);
//        linearLayoutManager.setStackFromEnd(true);
        myitem_place.setLayoutManager(linearLayoutManager);
        myitem_place.setHasFixedSize(true);
        list2 = new ArrayList<ReclockinItems>();
        getSessionId();
        cekInternet();
//        refreshnotif();
        if (internet){
...
//                                            pagination();
                            ...
                            Toast.makeText(ClockinApprovList.this, "Data Sudah di tampilkan semua", Toast.LENGTH_SHORT).show();
//                                    mfooterload.setVisibility(View.GONE);
...
//                    mcontent.setVisibility(View.GONE);
    ...
    public void loadData(){
        ...
        Call<JsonObject> panggilkomplek = jsonPostService.ListReclock(jsonObject);
        panggilkomplek.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                if (statusnya.equals("OK")){
                    ...
                    totalpage = 0;
                    listformreq = data.getAsJsonArray("approvalList");
                    totalrec = "0";
                    mrecord.setText("Record: "+totalrec);
                    Gson gson = new Gson();
                    Type listType = new TypeToken<ArrayList<ReclockinItems>>() {
                    }.getType();
                    list2 = gson.fromJson(listformreq.toString(), listType);
                    addFormAdapterAdapter = new ReClockInAdapter(ClockinApprovList.this, list2);
//                    addFormAdapterAdapter.notifyDataSetChanged();
                    ...
                    if (MsessionExpired.equals("true")) {
                        Toast.makeText(ClockinApprovList.this, errornya.toString(), Toast.LENGTH_SHORT).show();
                    }
                }
            ...
            public void onFailure(Call<JsonObject> call, Throwable t) {
                Toast.makeText(ClockinApprovList.this, getString(R.string.title_excpetation),Toast.LENGTH_LONG).show();
                cekInternet();
                mfooterload.setVisibility(View.GONE);
...
//    }
    public void cekInternet(){
        ...
        ConnectivityManager connectivityManager = (ConnectivityManager) ClockinApprovList.this.getSystemService(Context.CONNECTIVITY_SERVICE);
                ...
                connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI).getState() == NetworkInfo.State.CONNECTED)
        {
            ...
            internet=false;
            Intent noconnection = new Intent(ClockinApprovList.this, NoInternet.class);
...
//                finish();
            ...
            startActivity(new Intent(ClockinApprovList.this, Login.class));
            finish();
...
//                    loading.dismiss();
                    ...
                    if (clocksts){
                        ...
                        startActivity(new Intent(ClockinApprovList.this, ClockInActivity.class));
                        finish();
