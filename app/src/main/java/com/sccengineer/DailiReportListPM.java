...
public class DailiReportListPM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daili_report_list_p_m);
...
//            Log.d("noreqnya",noreq);
        ...
        mstartdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(DailiReportListPM.this, date, myCalendar
        ...
        menddate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(DailiReportListPM.this, date2, myCalendar
                        .get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
                        myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
...
//        }
        //setlayout recyler
        linearLayoutManager = new LinearLayoutManager(DailiReportListPM.this, LinearLayout.VERTICAL,false);
...
//                    addFormAdapterAdapter.notifyDataSetChanged();
                    ...
                    sesionid();
                    mfooterload.setVisibility(View.GONE);
                    Toast.makeText(DailiReportListPM.this, errornya,Toast.LENGTH_LONG).show();
                }
            ...
            public void onFailure(Call<JsonObject> call, Throwable t) {
                Toast.makeText(DailiReportListPM.this, getString(R.string.title_excpetation),Toast.LENGTH_LONG).show();
                cekInternet();
                mfooterload.setVisibility(View.GONE);
...
//                    page++;
    ...
    public void cekInternet(){
        ...
        ConnectivityManager connectivityManager = (ConnectivityManager) DailiReportListPM.this.getSystemService(Context.CONNECTIVITY_SERVICE);
                ...
                connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI).getState() == NetworkInfo.State.CONNECTED)
        {
            ...
            internet=false;
            Intent noconnection = new Intent(DailiReportListPM.this, NoInternet.class);
...
//                finish();
            ...
            startActivity(new Intent(DailiReportListPM.this, Login.class));
            finish();
            Toast.makeText(DailiReportListPM.this, getString(R.string.title_session_Expired),Toast.LENGTH_LONG).show();
        }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        if (hide.equals("yes")){
            Intent back = new Intent(DailiReportListPM.this, DetailsPM.class);
