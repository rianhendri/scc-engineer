...
public class Itemchat {
    ...
    public Itemchat(String date, String name, String message, String read, String key, String showDate, String time, String sendto, String url, String showUrl, int position, String myuri, String youruri, String level, String type, String thumb) {
        Date = date;
        Name = name;
        Message = message;
        Read = read;
