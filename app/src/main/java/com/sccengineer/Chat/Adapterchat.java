...
import static com.sccengineer.ListChat.chatin;
...
//                                loading.dismiss();
                        ...
                        Log.d("testsclace","tinggiori: "+String.valueOf(bitmap2.getHeight())+"-"+
                                "lebarori: "+String.valueOf(bitmap2.getWidth())+"-"+
                                "tinggi compress: "+String.valueOf(height)+"-"+
                                "lebar compres: "+String.valueOf(width)
                        );
                        byte[] data = baos.toByteArray();
