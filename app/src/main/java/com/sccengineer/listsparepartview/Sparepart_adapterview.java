...
public class Sparepart_adapterview
extends RecyclerView.Adapter<Sparepart_adapterview.Myviewholder> {
    ArrayList<Sparepart_itemview> addFoclistitem;
    ...
    public Sparepart_adapterview(Context context, ArrayList<Sparepart_itemview> addFoclistitem) {
...
////////////////////// adapter di masukan ke recyler//
    ...
    public void filterList(ArrayList<Sparepart_itemview> filteredList) {
