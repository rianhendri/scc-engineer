...
public class ApprovalActivity extends AppCompatActivity {
    ...
    ApprovalAdapter addFormAdapterAdapter;
    boolean internet = true;
    private LinearLayoutManager linearLayoutManager;
    public static ArrayList<ApprovalItem> list2;
...
//            Toast.makeText(DetailsNotification.this, guid,Toast.LENGTH_LONG).show();
        ...
        //setlayout recyler
        linearLayoutManager = new LinearLayoutManager(ApprovalActivity.this, LinearLayout.VERTICAL,false);
//        linearLayoutManager.setReverseLayout(true);
//        linearLayoutManager.setStackFromEnd(true);
        myitem_place.setLayoutManager(linearLayoutManager);
        myitem_place.setHasFixedSize(true);
        list2 = new ArrayList<ApprovalItem>();
        getSessionId();
        cekInternet();
//        refreshnotif();
        if (internet){
...
//                                            pagination();
                            ...
                            Toast.makeText(ApprovalActivity.this, "Data Sudah di tampilkan semua", Toast.LENGTH_SHORT).show();
//                                    mfooterload.setVisibility(View.GONE);
...
//                    mcontent.setVisibility(View.GONE);
    ...
    public void loadData(){
        ...
        Call<JsonObject> panggilkomplek = jsonPostService.ListApproval(jsonObject);
        panggilkomplek.enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                ...
                if (statusnya.equals("OK")){
                    ...
                    totalpage = 0;
                    listformreq = data.getAsJsonArray("requests");
                    totalrec = "0";
                    mrecord.setText("Record: "+totalrec);
                    Gson gson = new Gson();
                    Type listType = new TypeToken<ArrayList<ApprovalItem>>() {
                    }.getType();
                    list2 = gson.fromJson(listformreq.toString(), listType);
                    addFormAdapterAdapter = new ApprovalAdapter(ApprovalActivity.this, list2);
...
//    }
    public void cekInternet(){
        ...
        ConnectivityManager connectivityManager = (ConnectivityManager) ApprovalActivity.this.getSystemService(Context.CONNECTIVITY_SERVICE);
                ...
                connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_WIFI).getState() == NetworkInfo.State.CONNECTED)
        {
            ...
            internet=false;
            Intent noconnection = new Intent(ApprovalActivity.this, NoInternet.class);
...
//                finish();
            ...
            startActivity(new Intent(ApprovalActivity.this, Login.class));
            finish();
...
//                    loading.dismiss();
                    ...
                    if (clocksts){
                        ...
                        startActivity(new Intent(ApprovalActivity.this, ClockInActivity.class));
                        finish();
